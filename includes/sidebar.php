...
<aside id="sidebar" class="w-72 bg-white border-r border-gray-100 h-screen sticky top-0 hidden md:flex flex-col p-6 shadow-lg z-50">
    ...
    <nav class="flex-1 space-y-2 overflow-y-auto custom-scrollbar">
        ...
        // Stock Room Layout for Teacher/Admin
        if ($role === 'Admin' || $role === 'Teacher') {
            echo navItem($base_url . "HTML_Demo/stock_room.php", "Stock Room Layout", '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>', $current_script);
        }
